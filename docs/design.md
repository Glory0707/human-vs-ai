...
> v0.2 · 2026-09-20。已实现能力见 [README](../README.md)，本文只保留定位、原则、取舍与未竟事项。
...
- **P2**：general profile（问答/科普/自媒体文体，HC3 校准；S-TRIAD-01 复活于此）· 公文 profile（天然工整文体，需独立基线防误报）· 完整论文正文阈值分档（摘要/正文分开）· VS Code / Obsidian 插件 · 纯前端网页版
...
- **单元测试**：20 项（切分 6 / 统计 4 / 引擎 6 / 端到端区分度 4），`python -m pytest tests/ -q` 全绿
- **C-ReD paper 域首轮校准**（2026-09，真人 80 vs deepseek-v3/qwen-3/gpt-4o/deepseek-r1 各 80）：
  - 词表规则句均命中：真人 0.053 vs AI 0.185–0.338，AUROC **0.803**（删除反向规则前 0.626）
